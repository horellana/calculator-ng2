...
module.exports = "\n<div *ngFor=\"let input of inputs\">\n  <label>\n    {{input.name}}\n  </label>\n  <input [(ngModel)]=\"input.value\" (keyup)=\"onInput()\" type=\"numeric\"  size=\"1\">\n</div>\n\n<label>\n  Result:\n</label>\n\n{{c}}"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_main_main_component__ = __webpack_require__(78);
...
var MainComponent = (function () {
    function MainComponent() {
        this.inputs = [{ name: 'a', value: 0 },
            { name: 'b', value: 0 },
            { name: 'c', value: 0 }];
        this.c = 0;
    }
    MainComponent.prototype.onInput = function (event) {
        this.c = this.inputs.map(function (i) { return i.value; }).reduce(function (a, b) { return +a + +b; });
    };
